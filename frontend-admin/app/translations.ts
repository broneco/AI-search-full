export const TRANSLATIONS = {
  cs: {
    title: "Administrativní Konzole AI Search",
    subtitle: "Správa dokumentů, konfigurace vyhledávání, chunkování a audit",
    ...
    initialGreeting: "Dobrý den! Jsem Váš firemní vyhledávací asistent. Zadejte libovolný dotaz a já vyhledám odpověď v nahraných směrnicích a dokumentech. Odpověď bude podložená citacemi a přizpůsobí se Vašim přístupovým právům.",

...
export const TRANSLATIONS: Record<"cs" | "en", UserAppTranslations> = {
  cs: {
    ...
    subtitle: "Chytré vyhledávání ve firemních dokumentech s ověřenými citacemi",
    ...
    initialGreeting: "Dobrý den! Jsem Váš firemní AI vyhledávací asistent. Zadejte libovolný dotaz a já vyhledám odpověď v nahraných směrnicích a dokumentech. Odpověď bude podložená přímými citacemi a přizpůsobí se Vašim přístupovým právům.",
  ...
  en: {
    ...
    subtitle: "Intelligent search in corporate documents with verified citations",
    ...
    apiOfflineStatus: "API: Offline",
    userRoleLabel: "User:",
    initialGreeting: "Hello! I am your corporate AI search assistant. Ask any question and I will retrieve answers backed by citations from uploaded documents, adapted to your access rights.",
